    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
        ...
        <div className="flex items-center justify-between py-1 sm:col-span-2">
          <div>
            <p className="text-sm font-semibold text-slate-700">חיבור מאובטח (SSL/TLS ישיר)</p>
            <p className="text-sm text-muted-foreground mt-0.5">הפעל עבור פורט 465; השאר כבוי עבור STARTTLS (פורט 587, הנפוץ יותר)</p>
          </div>
