...
const CATEGORY_ACCENT = {
  ...
  "012": "border-brand-gold bg-brand-gold",   // מספרים בחיתוך לייזר
};
...
const CATEGORY_DEFAULTS = {
  ...
  // Numbers are a fixed-price catalog row (like kapa/glass) — the picked tier
  // already carries height+thickness, no dimension inputs needed here.
...
export default function CalculatorForm({ values, onChange, allowedProducts, extrasInfo, basePrice, unitPriceExVat, priceRangeMin, priceRangeMax, paymentKey = 'full', installmentCount = 2, config, kapaPriceTiers = [], rollupPriceTiers = [], glassPriceTiers = [], numberPriceTiers = [], priceMissing = false, priceErrorMessage = null }) {
